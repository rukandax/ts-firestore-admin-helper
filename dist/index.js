...
class FirestoreAdapter {
    constructor(serviceAccountPath, collectionPath) {
        this.collection = null;
        let serviceAccount;
        if (!fs.existsSync(serviceAccountPath)) {
            throw new Error(`Service account path does not exist: ${serviceAccountPath}`);
        }
        try {
        ...
        if (!serviceAccount) {
            throw new Error('Failed to initialize Firestore: Service account is not properly defined.');
        }
    ...
    handleInitializationError(error) {
        throw new Error(`Firestore initialization failed: ${this.getErrorMessage(error)}`);
    }
    checkConnection() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.collection) {
                ...
                const result = yield admin
                    .firestore()
                    .runTransaction((transaction) => __awaiter(this, void 0, void 0, function* () {
                    var _a;
    ...
    queryDocuments(filters_1) {
        return __awaiter(this, arguments, void 0, function* (filters, limit = 25, startAfterId) {
            if (this.collection) {
